...
def get_args():
    # TODO: check if input image exists(probably in main script not here)
    ...
    parser.add_argument('--overwrite', help="Overwrite original image file", action='store_true')
...
r = resize.resize.Resizer(args.image,out_res,args.output, args.multi_save,args.overwrite)
r.do_default()
